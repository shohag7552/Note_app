...
#ifndef SPEECH_TO_TEXT_SWIFT_H
#define SPEECH_TO_TEXT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="speech_to_text",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14speech_to_text18SpeechToTextPlugin") SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=10.0)
...
SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <AVAudioPlayerDelegate>
...
SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <SFSpeechRecognizerDelegate>
...
SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SpeechToTextPlugin (SWIFT_EXTENSION(speech_to_text)) <SFSpeechRecognitionTaskDelegate>
